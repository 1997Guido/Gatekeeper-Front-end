    ...
    <ol>
      ...
      <li>
        <p>
          ...
          that contains viruses or other harmful code, any unsolicited or
          unauthorized advertising, promotional materials, or other forms of
          solicitation.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          ...
          Service will be error-free or that the Service will meet any
          particular standards of performance or quality.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          ...
          Terms of Use, or your violation of any rights of another person or
          entity.
        </p>
      </li>
      <li>
        <p>
          Changes to the Terms of Use We reserve the right to make changes to
          these Terms of Use at any time. Your continued use of the Service
          following the posting of changes to these terms will mean you accept
          those changes.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          ...
          that complies with the laws of your jurisdiction.
        </p>
      </li>
    </ol>
    </div>
